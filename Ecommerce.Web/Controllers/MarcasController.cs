...
namespace Ecommerce.Web.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MarcaId,Nombre,Creado,Modificado,Eliminado")] Marca marca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MarcaId,Nombre,Creado,Modificado,Eliminado")] Marca marca)
        {
            if (id != marca.MarcaId)
            {
                return NotFound();
