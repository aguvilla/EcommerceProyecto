...
namespace Ecommerce.Web.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,Nombre,Creado,Modificado,Eliminado")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,Nombre,Creado,Modificado,Eliminado")] Categoria categoria)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    categoria.Modificado = DateTime.Now;
